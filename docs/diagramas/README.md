...
Visualizaciones con **Mermaid** que renderizan automáticamente en GitHub.

| # | Diagrama | Estado | Tipo |
|---|---|---|---|
...
> 💡 Cada diagrama está pensado para mostrarse en **entrevistas técnicas**:
> abrir GitHub → mostrar el diagrama → explicar en voz alta.
